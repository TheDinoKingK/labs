...
function tellMe(joke) {
  ...
  function test() {
    VoiceRSS.speech({
      key: '4051740deb4a4558b308c1b1428267aa',
      src: joke,
      hl: 'en-us',
      r: 0,
...
async function getJokes() {
  let joke = '';
  const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Pun?blacklistFlags=nsfw,religious,political,racist,sexist';
  try {
